  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      <div className="border-b border-[#1f293d] pb-6">
        <h1 className="text-3xl font-extrabold text-white">About TVS Raj Automobiles</h1>
        <p className="text-gray-400 text-sm mt-1">Your trusted authorized TVS dealership in Lahan, Siraha.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7 space-y-4 text-gray-300 text-sm leading-relaxed">
          <p>
        ...
        <div className="lg:col-span-5 grid grid-cols-2 gap-4">
          <div className="bg-[#151c2c] p-5 rounded-2xl border border-[#1f293d] text-center space-y-2">
            <Award className="w-8 h-8 text-[#0066CC] mx-auto" />
            <h3 className="font-bold text-white text-base">Authorized 3S</h3>
            <p className="text-xs text-gray-400">Sales, Service & Spares</p>
          </div>
          <div className="bg-[#151c2c] p-5 rounded-2xl border border-[#1f293d] text-center space-y-2">
            <Users className="w-8 h-8 text-[#0066CC] mx-auto" />
            <h3 className="font-bold text-white text-base">5,000+</h3>
            <p className="text-xs text-gray-400">Happy Customers</p>
          </div>
          <div className="bg-[#151c2c] p-5 rounded-2xl border border-[#1f293d] text-center space-y-2">
            <Wrench className="w-8 h-8 text-[#0066CC] mx-auto" />
            <h3 className="font-bold text-white text-base">Certified</h3>
            <p className="text-xs text-gray-400">Mechanics & Tools</p>
          </div>
          <div className="bg-[#151c2c] p-5 rounded-2xl border border-[#1f293d] text-center space-y-2">
            <ShieldCheck className="w-8 h-8 text-[#0066CC] mx-auto" />
            <h3 className="font-bold text-white text-base">100% Genuine</h3>
