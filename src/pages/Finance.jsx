  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-6">
      <div className="border-b border-[#1f293d] pb-5">
        <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight">TVS Bike Finance & Easy EMI</h1>
        <p className="text-gray-400 text-xs sm:text-sm mt-1">Affordable monthly installments with quick approval at TVS Raj Automobiles, Lahan.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-7 bg-[#151c2c] p-5 sm:p-7 rounded-2xl border border-[#1f293d] space-y-5">
          <div className="flex items-center space-x-3">
            <Landmark className="w-7 h-7 text-[#0066CC]" />
            <h2 className="text-xl sm:text-2xl font-bold text-white">Our Finance Partners</h2>
          </div>
          ...
          <div className="space-y-3.5 pt-4 border-t border-[#1f293d]">
            <h3 className="font-bold text-white text-sm sm:text-base">Required Documents for Finance</h3>
        ...
        <div className="lg:col-span-5 bg-[#151c2c] p-5 sm:p-7 rounded-2xl border border-[#1f293d] space-y-5 flex flex-col justify-between">
          <div className="space-y-3.5">
            <div className="flex items-center space-x-3">
              <Calculator className="w-7 h-7 text-[#0066CC]" />
              <h2 className="text-lg sm:text-xl font-bold text-white">Quick EMI Assistance</h2>
            </div>
          ...
          <div className="space-y-3 pt-5 border-t border-[#1f293d]">
