...
export default function EmployeeDashboard() {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 text-center space-y-4">
      ...
      <div className="px-4 py-2 rounded-lg bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 font-bold tracking-wide">
        Coming Soon
      </div>
      <p className="text-gray-400 max-w-md pb-4">
        This is a placeholder page for the employee dashboard. In future steps, this will be protected and filled with employee tools.
      </p>
